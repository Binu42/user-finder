...
const User = ({ getUser, getRepos, match, loading, repos, user }) => {
    useEffect(() => {
    ...
    const { name, company, avatar_url, bio, blog, login, location, html_url, followers, following, public_repos, public_gists, hireable } = user;
